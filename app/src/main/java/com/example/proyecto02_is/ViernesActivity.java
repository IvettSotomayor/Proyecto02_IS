...
public class ViernesActivity extends AppCompatActivity {
    ...
    public void create(){
        ...
        if(db != null){
            ...
            nuevoRegistro.put("nombre", "Turno Viernes: Mañana");
    ...
    public void create2(){
        ...
        if(db != null){
            ...
            nuevoRegistro.put("nombre", "Turno Viernes: Tarde");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.cambioVista:
                Intent intent = new Intent(ViernesActivity.this, JuevesActivity.class);
                startActivity(intent);
                return true;

            case R.id.cambioVista2:
                Intent intent2 = new Intent(ViernesActivity.this, SabadoActivity.class);
