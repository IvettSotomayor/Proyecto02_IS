...
public class JuevesActivity extends AppCompatActivity {
    ...
    public void create(){
        ...
        if(db != null){
            ...
            nuevoRegistro.put("nombre", "Turno Jueves: Mañana");
    ...
    public void create2(){
        ...
        if(db != null){
            ...
            nuevoRegistro.put("nombre", "Turno Jueves: Tarde");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.cambioVista:
                Intent intent = new Intent(JuevesActivity.this, MiercolesActivity.class);
                startActivity(intent);
                return true;

            case R.id.cambioVista2:
                Intent intent2 = new Intent(JuevesActivity.this, ViernesActivity.class);
