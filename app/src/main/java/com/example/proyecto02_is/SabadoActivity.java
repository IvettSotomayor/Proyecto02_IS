...
public class SabadoActivity extends AppCompatActivity {
    ...
    public void create(){
        ...
        if(db != null){
            ...
            nuevoRegistro.put("nombre", "Turno Sabado: Mañana");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.cambioVista:
                Intent intent = new Intent(SabadoActivity.this, ViernesActivity.class);
                startActivity(intent);
                return true;

            /*case R.id.cambioVista2:
                Intent intent2 = new Intent(SabadoActivity.this, MainActivity.class);
