...
public class MartesActivity extends AppCompatActivity {
    ...
    public void create2(){
        ...
        if(db != null){
            ...
            //nuevoRegistro.put("id", 2);
            nuevoRegistro.put("nombre", "Turno Martes: Tarde");
            nuevoRegistro.put("jornada", "De 14:00 a 20:00 Hrs.");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.cambioVista:
                Intent intent = new Intent(MartesActivity.this, MainActivity.class);
                startActivity(intent);
                return true;

            case R.id.cambioVista2:
                Intent intent2 = new Intent(MartesActivity.this, MiercolesActivity.class);
